...
## Plot it
png("out/SI_figs/FigS11.png",
  width = 9, height = 5, units = "in",
  res = 600
)
par(mai = c(1.1, 1.1, 0.1, 0.8))
plot(0, 0,
  xlim = c(16, 0), ylim = c(100, 625), type = "n",
...
## Plot it
png("out/SI_figs/FigS12.png",
  width = 9, height = 5, units = "in",
  res = 600
)
par(mai = c(1.1, 1.1, 0.1, 0.8))
plot(0, 0,
  xlim = c(16, 0), ylim = c(-150, 375), type = "n",
  axes = FALSE, xlab = "Age (Ma)", ylab = ""
)
...
axis(
  4, c(log(100), log(250), log(500), log(1000), log(2000)),
  c(100, 250, 500, 1000, 2000)
)
...
axis(
  2, c(log(250), log(500), log(1000), log(2000)),
  c(250, 500, 1000, 2000)
)
axis(3, c(66, 0), lwd.ticks = 0, labels = FALSE)
axis(3, seq(60, 0, by = -10))
